...
1. [OpenCode.ai]([https://opencode.ai)]([https://opencode.ai))]([https://opencode.ai)))]([https://opencode.ai))))]([https://opencode.ai)))))]([https://opencode.ai))))))]([https://opencode.ai)))))))]([https://opencode.ai))))))))]([https://opencode.ai)))))))))]([https://opencode.ai))))))))))]([https://opencode.ai)))))))))))](https://opencode.ai)))))))))))) installed
