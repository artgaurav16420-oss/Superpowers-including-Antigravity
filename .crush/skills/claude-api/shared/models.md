...
```bash
curl [https://api.anthropic.com/v1/models/claude-opus-4-7]([https://api.anthropic.com/v1/models/claude-opus-4-7)]([https://api.anthropic.com/v1/models/claude-opus-4-7))](https://api.anthropic.com/v1/models/claude-opus-4-7))) \
