...
{
  "mcp_servers": [
    { "type": "url", "name": "linear", "url": "[https://mcp.linear.app/mcp"]([https://mcp.linear.app/mcp")]([https://mcp.linear.app/mcp"))]([https://mcp.linear.app/mcp")))](https://mcp.linear.app/mcp")))) }
  ],
  "tools": [
...
```json
{
  ...
  "auth": {
    "type": "mcp_oauth",
    "mcp_server_url": "[https://mcp.notion.com/mcp",]([https://mcp.notion.com/mcp",)]([https://mcp.notion.com/mcp",))]([https://mcp.notion.com/mcp",)))](https://mcp.notion.com/mcp",))))
    "access_token": "<current access token>",
    "expires_at": "2026-04-02T14:00:00Z",
    "refresh": {
      "refresh_token": "<refresh token>",
      "client_id": "<your OAuth client_id>",
      "token_endpoint": "[https://api.notion.com/v1/oauth/token",]([https://api.notion.com/v1/oauth/token",)]([https://api.notion.com/v1/oauth/token",))]([https://api.notion.com/v1/oauth/token",)))](https://api.notion.com/v1/oauth/token",))))
