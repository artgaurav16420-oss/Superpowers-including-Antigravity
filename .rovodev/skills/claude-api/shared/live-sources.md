...
1. User explicitly asks for "latest" or "current" information
1. Cached data seems incorrect
1. User asks about features not covered in cached content
1. User needs specific API details or examples
