...
var credential = client.beta().vaults().credentials().create(vault.id(),
    CredentialCreateParams.builder()
        ...
        .auth(BetaManagedAgentsMcpOAuthCreateParams.builder()
            ...
            .mcpServerUrl("[https://mcp.slack.com/mcp")](https://m)cp.slack.com/mcp"))]([https://mcp.slack.com/mcp")))](https://m)cp.slack.com/mcp"))))]([https://mcp.slack.com/mcp")))))](https://m)cp.slack.com/mcp"))))))]([https://mcp.slack.com/mcp")))))))](https://m)cp.slack.com/mcp"))))))))](https://mcp.slack.com/mcp")
            .accessToken("xoxp-...")
