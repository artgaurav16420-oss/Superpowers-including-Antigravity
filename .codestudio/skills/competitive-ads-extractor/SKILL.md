...
1. **Captures Screenshots**: Saves visual copies of all ads

1. **Analyzes Messaging**: Identifies problems, use cases, and value props

1. **Categorizes Ads**: Groups by theme, audience, or format

1. **Identifies Patterns**: Finds common successful approaches

1. **Provides Insights**: Explains why certain ads likely perform well
...
1. **Track over time**: Save ads monthly to see evolution

1. **Test hypotheses**: Adapt successful patterns for your brand

1. **Segment by audience**: Different messages for different targets

1. **Compare platforms**: LinkedIn vs Facebook messaging differs
...
1. Note gaps in their messaging

1. Brainstorm unique angles

1. Draft test ad variations

### Positioning Research

1. Get ads from 5 competitors

1. Map their positioning

1. Find underserved angles

1. Develop differentiated messaging

1. Test against their approaches
...
1. Note color and layout trends

1. Adapt successful patterns

1. Create original variations

## Tips for Success

1. **Regular Monitoring**: Check monthly for changes

1. **Broad Research**: Look at adjacent competitors too

1. **Save Everything**: Build a reference library

1. **Test Insights**: Run your own experiments

1. **Track Performance**: A/B test inspired concepts

1. **Stay Original**: Use for inspiration, not copying

1. **Multiple Platforms**: Compare Facebook, LinkedIn, TikTok, etc.
