...
const agent = await client.beta.agents.create(
  {
    ...
    mcp_servers: [
      { type: 'url', name: 'github', url: '[https://api.githubcopilot.com/mcp/']([https://api.githubcopilot.com/mcp/')]([https://api.githubcopilot.com/mcp/'))]([https://api.githubcopilot.com/mcp/')))]([https://api.githubcopilot.com/mcp/'))))](https://api.githubcopilot.com/mcp/'))))) },
    ],
    tools: [
