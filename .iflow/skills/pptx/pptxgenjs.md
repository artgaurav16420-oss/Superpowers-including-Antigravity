...
// From URL
slide.addImage({ path: "[https://example.com/image.jpg",]([https://example.com/image.jpg",)]([https://example.com/image.jpg",))]([https://example.com/image.jpg",)))]([https://example.com/image.jpg",))))]([https://example.com/image.jpg",)))))]([https://example.com/image.jpg",))))))](https://example.com/image.jpg",))))))) x: 1, y: 1, w: 5, h: 3 });
...
slide.addImage({
  ...
  hyperlink: { url: "[https://example.com"]([https://example.com")]([https://example.com"))]([https://example.com")))]([https://example.com"))))]([https://example.com")))))]([https://example.com"))))))](https://example.com"))))))) }
});
```
...
// Image from URL
slide.background = { path: "[https://example.com/bg.jpg"]([https://example.com/bg.jpg")]([https://example.com/bg.jpg"))]([https://example.com/bg.jpg")))]([https://example.com/bg.jpg"))))]([https://example.com/bg.jpg")))))]([https://example.com/bg.jpg"))))))](https://example.com/bg.jpg"))))))) };
