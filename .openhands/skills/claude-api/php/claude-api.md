...
$client = Foundry\Client::withCredentials(
    ...
    baseUrl: '[https://<resourc]([https://<resourc)]([https://<resourc))](https://<resourc)))e>.services.ai.azure.com/anthropic',
);
```
...
$response = $client->beta->messages->create(
    ...
    mcpServers: [
        BetaRequestMCPServerURLDefinition::with(
            name: 'my-server',
            url: '[https://example.com/mcp',]([https://example.com/mcp',)]([https://example.com/mcp',))](https://example.com/mcp',)))
        ),
    ],
