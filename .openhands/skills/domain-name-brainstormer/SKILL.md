...
1. **Generates Creative Names**: Creates relevant, memorable domain options

1. **Checks Availability**: Verifies which domains are actually available across multiple TLDs

1. **Multiple Extensions**: Suggests .com, .io, .dev, .ai, .app, and more

1. **Provides Alternatives**: Offers variations if top choices are taken
...
1. Get 10-15 domain suggestions across TLDs

1. Review availability and pricing

1. Pick top 3 favorites
...
1. Get variations (firstname.com, firstnamelastname.dev, etc.)

1. Check social media handle availability too

1. Register consistent brand across platforms

### Product Naming

1. Describe product and target market

1. Get creative, brandable names

1. Check trademark conflicts

1. Verify domain and social availability

1. Test names with target audience

## Tips for Success

1. **Act Fast**: Good domains get taken quickly

1. **Register Variations**: Get .com and .io to protect brand

1. **Avoid Numbers**: Hard to communicate verbally

1. **Check Social Media**: Make sure @username is available too

1. **Say It Out Loud**: Test if it's easy to pronounce

1. **Check Trademarks**: Ensure no legal conflicts

1. **Think Long-term**: Will it still make sense in 5 years?
