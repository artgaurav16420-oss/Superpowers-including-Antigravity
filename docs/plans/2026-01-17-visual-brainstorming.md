...
Tell the user: "I've started a visual companion at [http://localhost:3333]([http://localhost:3333)]([http://localhost:3333))]([http://localhost:3333)))](http://localhost:3333)))) - open it in a browser."
...
2. Tell user to open [http://localhost:3333]([http://localhost:3333)]([http://localhost:3333))]([http://localhost:3333)))](http://localhost:3333))))
