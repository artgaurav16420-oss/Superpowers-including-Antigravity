...
Complete guide for using Mega-Skills with [OpenCode.ai]([https://opencode.ai).]([https://opencode.ai).)]([https://opencode.ai).))]([https://opencode.ai).)))]([https://opencode.ai).))))]([https://opencode.ai).)))))]([https://opencode.ai).))))))]([https://opencode.ai).)))))))]([https://opencode.ai).))))))))]([https://opencode.ai).)))))))))]([https://opencode.ai).))))))))))](https://opencode.ai).)))))))))))
...
1. OpenCode docs: [https://opencode.ai/docs/]([https://opencode.ai/docs/)]([https://opencode.ai/docs/))]([https://opencode.ai/docs/)))]([https://opencode.ai/docs/))))]([https://opencode.ai/docs/)))))]([https://opencode.ai/docs/))))))]([https://opencode.ai/docs/)))))))]([https://opencode.ai/docs/))))))))]([https://opencode.ai/docs/)))))))))]([https://opencode.ai/docs/))))))))))](https://opencode.ai/docs/)))))))))))
