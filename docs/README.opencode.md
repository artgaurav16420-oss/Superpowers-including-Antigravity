...
Complete guide for using Mega-Skills with [OpenCode.ai]([https://opencode.ai).](https://opencode.ai).)
...
```json
{
  "plugin": ["superpowers@git+[https://github.com/artgaurav16420-oss/Mega-Skills.git](https://github.com/artgaurav16420-oss/Mega-Skills.git)"]
}
```
...
```json
{
  "plugin": ["superpowers@git+[https://github.com/artgaurav16420-oss/Mega-Skills.git#v5.0.3](https://github.com/artgaurav16420-oss/Mega-Skills.git#v5.0.3)"]
}
```
