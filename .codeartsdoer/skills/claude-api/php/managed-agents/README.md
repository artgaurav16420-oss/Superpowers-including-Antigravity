...
$csvPath = 'data.csv';
$ch = curl_init('[https://api.anthropic.com/v1/files');]([https://api.anthropic.com/v1/files');)]([https://api.anthropic.com/v1/files');))]([https://api.anthropic.com/v1/files');)))](https://api.anthropic.com/v1/files');))))
...
$credential = $client->beta->vaults->credentials->create(
    ...
    auth: [
        'type' => 'mcp_oauth',
        'mcp_server_url' => '[https://mcp.slack.com/mcp',]([https://mcp.slack.com/mcp',)]([https://mcp.slack.com/mcp',))]([https://mcp.slack.com/mcp',)))](https://mcp.slack.com/mcp',))))
        'access_token' => 'xoxp-...',
        'expires_at' => '2026-04-15T00:00:00Z',
        'refresh' => [
            'token_endpoint' => '[https://slack.com/api/oauth.v2.access',]([https://slack.com/api/oauth.v2.access',)]([https://slack.com/api/oauth.v2.access',))]([https://slack.com/api/oauth.v2.access',)))](https://slack.com/api/oauth.v2.access',))))
