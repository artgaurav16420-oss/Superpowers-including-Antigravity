...
mkdir -p src test docs/mega-skills/plans

# Create a simple implementation plan
cat > docs/mega-skills/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/mega-skills/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from mega-skills directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/mega-skills/plans/implementation-plan.md using the subagent-driven-development skill.
